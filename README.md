...
[![This version of 'sendbird-chat' @ Cloudsmith](https://api-prd.cloudsmith.io/v1/badges/version/sendbird/release/maven/sendbird-chat/4.0.0-beta.5/a=noarch;xg=com.sendbird.sdk/?render=true)](https://cloudsmith.io/~sendbird/repos/release/packages/detail/maven/sendbird-chat/4.0.0-beta.5/a=noarch;xg=com.sendbird.sdk/)
...
dependencies {
    ...
    implementation 'com.sendbird.sdk:sendbird-chat:4.0.0-beta.5'
    ...
}
```
